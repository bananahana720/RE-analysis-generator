...
def test_utility_function_imports():
    ...
    from phoenix_real_estate.foundation.utils.helpers import (
        ...
        generate_property_id, retry_async
    )
...
def test_exception_hierarchy():
    ...
    from phoenix_real_estate.foundation.utils.exceptions import (
        PhoenixREError, ConfigurationError, DatabaseError, 
        ValidationError, DataCollectionError, ProcessingError, OrchestrationError
    )
...
def test_comprehensive_utility_workflow():
    ...
    from phoenix_real_estate.foundation.utils.helpers import (
        safe_int, safe_float, normalize_address, is_valid_zipcode, generate_property_id
    )
