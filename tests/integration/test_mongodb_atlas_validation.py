...
class TestMongoDBAtlasScripts:
    ...
    async def test_validate_connection_success(self):
        ...
        with patch('scripts.validate_mongodb_atlas.get_database_connection', return_value=mock_connection):
    ...
    async def test_real_database_ping(self, skip_if_no_env):
        ...
        try:
            ...
            try:
                ...
                pytest.skip(f"Database connection failed (this is expected if MongoDB Atlas isn't set up): {str(e)}")
