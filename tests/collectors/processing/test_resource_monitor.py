...
class TestResourceMonitor:
    ...
    async def test_resource_reservation(self, monitor):
        ...
        reservation_id = await monitor.reserve_resources(
            memory_mb=100, cpu_cores=2, duration_seconds=10
        )
    ...
    def test_metrics_aggregation(self):
        ...
        for i in range(10):
            metrics.record_datapoint(
                memory_mb=100 + i * 10, cpu_percent=20 + i * 5, active_operations=i
            )
...
class TestResourceLimits:
    ...
    def test_limit_validation(self):
        ...
        limits = ResourceLimits(max_memory_mb=1024, max_cpu_percent=80, max_concurrent_requests=10)
    ...
    def test_dynamic_adjustment(self):
        ...
        limits = ResourceLimits(max_memory_mb=1024, dynamic_adjustment=True)
