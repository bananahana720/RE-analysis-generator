...
class TestLLMProcessingService:
    ...
    async def test_llm_health_check_database_unhealthy(self, started_service):
        ...
        started_service.db_client.health_check = AsyncMock(
    ...
    async def test_process_property_success(self, started_service):
        ...
        request.json = AsyncMock(
            return_value={"source": "test_source", "data": {"property": "test"}}
        )
        ...
        with patch(
            "phoenix_real_estate.collectors.processing.service.processing_requests"
        ) as mock_counter:
            ...
            started_service.processing_queue.put.assert_called_once_with(
                {"source": "test_source", "data": {"property": "test"}}
            )
    ...
    async def test_process_worker_success(self, started_service):
        ...
        test_item = {"source": "test_source", "data": {"property": "test"}}
        ...
        with (
            patch(
                "phoenix_real_estate.collectors.processing.service.processing_duration"
            ) as mock_histogram,
            patch(
                "phoenix_real_estate.collectors.processing.service.processing_requests"
            ) as mock_counter,
            ...
            ]  # First call returns item, second times out
    ...
    async def test_process_worker_processing_failure(self, started_service):
        ...
        test_item = {"source": "test_source", "data": {"should_fail": True}}
