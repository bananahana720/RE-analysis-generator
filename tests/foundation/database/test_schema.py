...
class TestPropertyAddress:
    ...
    def test_valid_address(self):
        ...
        address = PropertyAddress(street="123 Main St", zipcode="85001")
...
class TestPropertyFeatures:
    ...
    def test_valid_features(self):
        ...
        features = PropertyFeatures(bedrooms=3, bathrooms=2.5, square_feet=1800, year_built=2010)
...
class TestPropertyPrice:
    ...
    def test_valid_price(self):
        ...
        now = datetime.now()
        price = PropertyPrice(
            amount=350000, date=now, price_type="listing", source=DataSource.PHOENIX_MLS
        )
...
class TestPropertyTaxInfo:
    ...
    def test_valid_tax_info(self):
        ...
        tax_info = PropertyTaxInfo(
            apn="123-45-678", assessed_value=250000, tax_amount_annual=3500, tax_year=2024
        )
...
class TestProperty:
    ...
    def test_minimal_property(self):
        ...
        prop = Property(
            property_id="test_123", address=PropertyAddress(street="123 Test St", zipcode="85001")
        )
    ...
    def test_complete_property(self):
        ...
        prop = Property(
            ...
            address=PropertyAddress(street="456 Complete Ave", zipcode="85002"),
            property_type=PropertyType.CONDO,
            features=PropertyFeatures(bedrooms=2, bathrooms=2.0, square_feet=1200),
            current_price=275000,
            price_history=[
                PropertyPrice(
                    amount=275000, date=now, price_type="listing", source=DataSource.PHOENIX_MLS
                )
            ],
            listing=PropertyListing(mls_id="MLS789", status=ListingStatus.ACTIVE, listing_date=now),
            tax_info=PropertyTaxInfo(assessed_value=250000, tax_amount_annual=3000),
            sources=[DataCollectionMetadata(source=DataSource.PHOENIX_MLS, quality_score=0.95)],
        )
    ...
    def test_computed_fields(self):
        ...
        prop2 = Property(
            ...
            listing=PropertyListing(listing_date=listing_date, status=ListingStatus.ACTIVE),
        )
        ...
        prop3 = Property(
            ...
            listing=PropertyListing(listing_date=listing_date, status=ListingStatus.SOLD),
        )
    ...
    def test_model_serialization(self):
        ...
        prop = Property(
            ...
            address=PropertyAddress(street="987 Serial Blvd", zipcode="85006"),
...
class TestDailyReport:
    ...
    def test_complete_report(self):
        ...
        report = DailyReport(
            ...
            properties_by_source={DataSource.PHOENIX_MLS: 100, DataSource.MARICOPA_COUNTY: 50},
            properties_by_zipcode={"85001": 30, "85002": 45, "85003": 75},
            price_statistics={"min": 150000, "max": 1500000, "avg": 425000, "median": 380000},
...
class TestSchemaIntegration:
    ...
    def test_property_with_multiple_price_updates(self):
        ...
        prop = Property(
            ...
            address=PropertyAddress(street="111 Price History Dr", zipcode="85007"),
    ...
    def test_property_lifecycle(self):
        ...
        prop = Property(
            ...
            address=PropertyAddress(street="222 Lifecycle Ln", zipcode="85008"),
            listing=PropertyListing(
                status=ListingStatus.ACTIVE, listing_date=datetime.now() - timedelta(days=30)
            ),
        )
