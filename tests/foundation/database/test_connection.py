...
class TestDatabaseConnection:
    ...
    def test_singleton_pattern(self):
        ...
        instance1 = DatabaseConnection.get_instance("mongodb://localhost:27017", "test_db")
        instance2 = DatabaseConnection.get_instance("mongodb://localhost:27017", "test_db")
    ...
    def test_singleton_thread_safety(self):
        ...
        def create_instance():
            instance = DatabaseConnection.get_instance("mongodb://localhost:27017", "test_db")
    ...
    async def test_connect_success(self, mock_motor_client):
        ...
        with patch(
            ...
            db_conn = DatabaseConnection.get_instance("mongodb://localhost:27017", "test_db")
    ...
    async def test_health_check_connected(self, mock_motor_client):
        ...
        mock_db.command = AsyncMock(
            return_value={"collections": 2, "dataSize": 1024, "storageSize": 2048, "indexes": 5}
        )
    ...
    def test_mask_uri(self):
        ...
        db_conn = DatabaseConnection("mongodb://user:password@localhost:27017", "test_db")
    ...
    def test_repr(self):
        ...
        db_conn = DatabaseConnection(
            "mongodb://localhost:27017", "test_db", max_pool_size=5, min_pool_size=2
        )
