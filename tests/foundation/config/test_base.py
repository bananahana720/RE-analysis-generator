...
class TestEnvironmentConfigProvider:
    ...
    def base_config(self, temp_config_dir):
        ...
        config = {
            "database": {"host": "localhost", "port": 5432, "name": "phoenix_re"},
            "api": {"timeout": 30, "retries": 3},
            "features": {"cache_enabled": True, "debug": False},
        }
    ...
    def dev_config(self, temp_config_dir):
        ...
        config = {
            "database": {"host": "dev.localhost", "name": "phoenix_re_dev"},
            "features": {"debug": True},
        }
    ...
    def test_validate_invalid_zipcode(self, temp_config_dir):
        ...
        config = {"collection": {"target_zipcodes": ["85001", "12345", "invalid", "85032-1234"]}}
    ...
    def test_yaml_parse_error(self, temp_config_dir):
        ...
        with pytest.raises(ConfigurationError) as exc_info:
            EnvironmentConfigProvider(config_dir=temp_config_dir, load_dotenv=False)
    ...
    def test_missing_config_directory(self):
        ...
        provider = EnvironmentConfigProvider(config_dir="/nonexistent/directory", load_dotenv=False)
