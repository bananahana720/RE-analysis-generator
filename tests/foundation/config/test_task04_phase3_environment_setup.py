...
""".strip())
        ...
        dev_env = EnvironmentConfigProvider(
            config_dir=config_dir,
            environment='development'
        )
        ...
        test_env = EnvironmentConfigProvider(
            config_dir=config_dir,
            environment='testing'
        )
        ...
        prod_env = EnvironmentConfigProvider(
            config_dir=config_dir,
    ...
    async def test_environment_specific_validation_rules(self, temp_env_dir):
        ...
        prod_config = EnvironmentConfigProvider(
            config_dir=config_dir,
            environment='production'
        )
        ...
        secret_errors = [error for error in validation_errors 
        ...
        secret_errors_fixed = [error for error in validation_errors_fixed 
                              if 'secret' in error.lower() and 'character' in error.lower()]
        ...
        dev_config = EnvironmentConfigProvider(
            config_dir=config_dir,
            environment='development'
        )
        ...
        dev_secret_errors = [error for error in dev_validation_errors 
                            if 'secret' in error.lower() and 'character' in error.lower()]
