...
class TestEnvironmentVariableLoading:
    ...
    def clean_env(self):
        ...
        env_vars_to_remove = [
            ...
            if k.startswith('PHOENIX_') or k in ['MONGODB_URI', 'LOG_LEVEL', 'API_KEY', 'DEBUG_MODE']
        ]
...
class TestValidationMethods:
    ...
    def test_zipcode_validation(self, temp_config_dir):
        ...
        config_with_zips = {
            ...
            "collection": {
                "target_zipcodes": ["85001", "invalid", "123", "85002-1234"]
            }
        }
...
class TestEnhancedFeatures:
    ...
    def clean_env(self):
        ...
        env_vars_to_remove = [
            k for k in os.environ.keys() 
            if k.startswith('PHOENIX_') or k in ['MONGODB_URI', 'LOG_LEVEL', 'API_KEY', 'DEBUG_MODE', 'ENVIRONMENT']
        ]
        for var in env_vars_to_remove:
            os.environ.pop(var, None)
