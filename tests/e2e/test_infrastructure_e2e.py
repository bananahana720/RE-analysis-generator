            ...
            "properties": [
                {
                    ...
                    "features": {"beds": 3, "baths": 2, "sqft": 1500, "year_built": 2020},
                    "listing": {"price": 350000, "status": "active", "days_on_market": 7},
                    "source": "mock_mls",
                ...
                },
                {
                    ...
                    "features": {"beds": 4, "baths": 3, "sqft": 2200, "year_built": 2018},
                    "listing": {"price": 450000, "status": "active", "days_on_market": 14},
                    "source": "mock_mls",
                    "last_updated": datetime.utcnow(),
                },
            ],
            "metadata": {"total_found": 2, "collection_time": 0.1, "success": True},
        }
...
class TestInfrastructureE2E:
    ...
    async def test_complete_data_pipeline(self, test_config, test_db_client):
        ...
        try:
            ...
            assert db_count == stored_count, (
                f"Database count mismatch: {db_count} vs {stored_count}"
            )
            ...
            properties.append(
                {
                    ...
                    "features": {"beds": 3, "baths": 2, "sqft": 1500 + i * 10},
                    "listing": {"price": 300000 + i * 1000, "status": "active"},
