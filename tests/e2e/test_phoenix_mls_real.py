...
class TestPhoenixMLSE2E:
    ...
    async def test_phoenix_mls_navigation(self, browser: Browser):
        ...
        try:
            ...
            response = await page.goto(
                "https://armls.com/search/85031", wait_until="networkidle", timeout=30000
            )
    ...
    async def test_full_collection_pipeline(
        self, browser: Browser, settings: Settings, test_database: MongoDBClient
    ):
        ...
        try:
            ...
            for prop in properties_collected:
                ...
                assert saved_prop is not None, (
                    f"Property {prop['property_id']} not found in database"
                )
    ...
    async def test_error_handling_and_recovery(self, browser: Browser, settings: Settings):
        ...
        try:
            ...
            response = await page.goto(
                "https://armls.com/invalid-page-12345", wait_until="networkidle"
            )
