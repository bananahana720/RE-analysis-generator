...
def get_llm_completion_message():
    ...
    Priority order: OpenRouter > OpenAI > Anthropic > fallback to random message
    ...
    if os.getenv("OPENROUTER_API_KEY"):
        ...
        if openrouter_script.exists():
            try:
                ...
                print(f"DEBUG: OpenRouter exception: {e}", file=sys.stderr)
                pass
    else:
        print("DEBUG: OPENROUTER_API_KEY not found in environment", file=sys.stderr)
