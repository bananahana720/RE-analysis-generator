...
class HealthCheckService:
    ...
    async def check_ollama_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                await self.ollama_client._generate(
                    "Test",
                    max_tokens=10
                )
    ...
    def check_queue_health(self) -> Dict[str, Any]:
        ...
        try:
            if not self.processing_queue:
                return {
                    "status": "unavailable",
                    "message": "Processing queue not configured"
                }
    ...
    async def check_resource_monitor(self) -> Dict[str, Any]:
        ...
        try:
            if not self.resource_monitor:
                return {
                    "status": "unavailable",
                    "message": "Resource monitor not configured"
                }
    ...
    async def get_comprehensive_health(self) -> Dict[str, Any]:
        ...
        ollama_health = results[1] if not isinstance(results[1], Exception) else {
            "status": "error", 
            "error": str(results[1])
        }
        
        resource_monitor_health = results[2] if not isinstance(results[2], Exception) else {
            "status": "error",
            "error": str(results[2])
        }
