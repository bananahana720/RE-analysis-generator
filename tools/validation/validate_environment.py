...
class EnvironmentValidator:
    ...
    def _validate_python_version(self):
        ...
        try:
            ...
            self._add_result(
                "Environment", "Python Version", "CRITICAL", f"Failed to check Python version: {e}"
            )
    ...
    def _validate_uv_setup(self):
        ...
        try:
            ...
            self._add_result(
                "Environment", "UV Setup", "CRITICAL", f"Failed to validate UV setup: {e}"
            )
    ...
    def _validate_project_structure(self):
        ...
        if missing_paths:
            ...
            self._add_result(
                "Project Structure", "Required Paths", "PASS", "All required project paths exist"
            )
    ...
    def _validate_secrets_management(self):
        ...
        try:
            ...
            if env_sample.exists():
                ...
                self._add_result(
                    "Secrets", "Sample Environment File", "WARNING", ".env.sample file missing"
                )
            ...
            SecretManager()
            self._add_result(
                "Secrets", "Secret Manager", "PASS", "Secret manager initialized successfully"
            )

        except Exception as e:
            self._add_result(
                "Secrets", "Management System", "CRITICAL", f"Secrets management failed: {e}"
            )
    ...
    def _validate_database_connection(self):
        ...
        try:
            ...
            self._add_result(
                "Database", "Module Imports", "PASS", "Database modules imported successfully"
            )
            ...
            self._add_result(
                "Database", "Module System", "CRITICAL", f"Database module system failed: {e}"
            )
    ...
    def _validate_test_framework(self):
        ...
        try:
            ...
            if tests_dir.exists():
                ...
                self._add_result(
                    "Testing", "Test Framework", "WARNING", "Tests directory not found"
                )

        except ImportError:
            self._add_result("Testing", "Test Framework", "CRITICAL", "pytest not available")
    ...
    def _print_summary(self):
        ...
        for cat, counts in categories.items():
            print(
                f"  {cat}: {counts['pass']} passed, {counts['warn']} warnings, {counts['critical']} critical"
            )
