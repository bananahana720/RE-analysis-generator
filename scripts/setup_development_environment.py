...
class DevelopmentEnvironmentSetup:
    ...
    def _validate_environment_variables(self) -> None:
        ...
        for var, description in recommended_vars.items():
            value = os.environ.get(var)
            if not value:
                self.warnings.append(f"Recommended environment variable not set: {var} ({description})")
            else:
                self.success_messages.append(f"✅ {var} configured")
        ...
        try:
            ...
            try:
                ...
                if 'uri' in db_config:
                    ...
                    self.success_messages.append("✅ Database configuration loaded (component-based)")
            except Exception as e:
        ...
        try:
            ...
            for secret_name in test_secrets:
                ...
                if secret_value:
                    ...
                    self.success_messages.append(f"✅ Secret retrieved: {secret_name} = {masked_value}")
    ...
    def _test_component_integration(self) -> None:
        ...
        try:
            ...
            rate_config = {
                ...
                'window_size': config.get_typed('COLLECTION_RATE_LIMITING_WINDOW_SIZE_MINUTES', int, 60)
            }
...
# Processing Settings
PROCESSING_LLM_MODEL=llama2:7b
