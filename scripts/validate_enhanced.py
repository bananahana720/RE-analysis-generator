...
def validate_package_imports() -> bool:
    ...
    import_tests = [
        ...
        ("foundation exceptions", lambda: __import__("phoenix_real_estate.foundation.utils.exceptions")),
...
def validate_functionality() -> bool:
    ...
    functionality_tests = [
        ...
        ("Package structure", "uv run python -c \"import phoenix_real_estate; print(phoenix_real_estate.__version__)\""),
        ("Foundation layer", "uv run python -c \"from phoenix_real_estate.foundation import get_logger; print('OK')\""),
    ]
