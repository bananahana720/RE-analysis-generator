...
class ServiceConfigurator:
                    ...
                    if response.status == 200:
                        ...
                        if data.get('status') == 1:
                            ...
                            if float(balance) < 0.01:
                                print("[WARNING] Low balance! Add funds to continue using the service.")
    ...
    def update_proxy_config(self, username: str, password: str):
        ...
        content = content.replace("YOUR_WEBSHARE_API_KEY_HERE", password)  # WebShare uses password as API key
