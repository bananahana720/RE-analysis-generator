...
def get_mongodb_atlas_instructions():
    ...
    print(
        "mongodb+srv://username:password@cluster0.xxxxx.mongodb.net/phoenix_real_estate?retryWrites=true&w=majority"
    )
    print()
...
def interactive_setup():
    ...
    while True:
        ...
        print(
            "(Example: mongodb+srv://username:password@cluster0.xxxxx.mongodb.net/phoenix_real_estate)"
        )
    ...
    return {"mongodb_uri": mongodb_uri, "database_name": database_name, "environment": environment}
...
def main():
    ...
    print()
    show_instructions = (
        input("Do you need MongoDB Atlas setup instructions? (y/N): ").strip().lower()
    )
