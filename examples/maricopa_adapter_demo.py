...
async def main():
    ...
    try:
        ...
        print(f"     Bathrooms: {property_obj.features.bathrooms} + {property_obj.features.half_bathrooms} half")
        ...
        for i, price in enumerate(property_obj.price_history, 1):
            print(f"     {i}. {price.price_type}: ${price.amount:,.2f} (confidence: {price.confidence})")
        print()
        ...
        print(f"   Epic 1 Utility: normalize_address() applied")
